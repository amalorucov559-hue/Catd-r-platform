...
let restaurants = [
    { 
        ...
        time: "15-25 dəq",
        menu: [
            { id: 101, name: "Miks Pizza", price: 12.0 }
        ] 
    }
];
...
app.get('/', (req, res) => {
    ...
    <body>
        ...
        <div class="role-selector">
            <button class="role-btn active" onclick="switchPanel(this, 'customer')">🙋‍♂️ Sifarişçi</button>
            <button class="role-btn" onclick="switchPanel(this, 'kitchen')">🍳 Mətbəx</button>
            <button class="role-btn" onclick="switchPanel(this, 'courier')">🏍️ Kuryer</button>
        </div>
        ...
        <div class="container">
            ...
            <div id="kitchenPanel" class="panel">
                <div class="card">
                    ...
                    <p style="color:#747d8c; font-size:13px;">Yeni gələn sifarişlər:</p>
            ...
            <div id="courierPanel" class="panel">
                <div class="card">
                    ...
                    <p style="color:#747d8c; font-size:13px;">Hazır sifarişlər:</p>
        ...
        <script>
            ...
            function switchPanel(buttonElement, panelName) {
            ...
            async function refreshCustomerSide() {
                ...
                if(data.status === "KURYERDƏ (Yoldadır)") {
                    document.getElementById('mapPlaceholder').innerText = "Kuryer Raul ünvanınıza gəlir...";
                    document.getElementById('customerMapMarker').style.display = 'block';
                } else if(data.status === "ÇATDIRILDI") {
                    document.getElementById('mapPlaceholder').innerText = "Sifarişiniz çatdırıldı! Nuş olsun.";
            ...
            async function loadKitchenOrders() {
                ...
                container.innerHTML = orders.map(o => \`
                    <div style="background:#f1f2f6; padding:15px; border-radius:10px; margin-bottom:10px;">
                        ...
                        <span class="status-badge" style="margin-bottom:10px; display:inline-block;">\${o.status}</span>
            ...
            async function updateOrderStatus(id, status) {
                ...
                alert('Mətbəx: Yemək hazırdır! Kuryerlərə bildiriş göndərildi.');
                loadKitchenOrders();
            }
            ...
            async function loadCourierOrders() {
                ...
                if(orders.length === 0) {
                    container.innerHTML = '<p style="color:#a4b0be; text-align:center;">Hazır yemək yoxdur, mətbəxi gözləyin...</p>';
                    return;
                }
                ...
                container.innerHTML = orders.map(o => \`
                    <div style="background:#f1f2f6; padding:15px; border-radius:10px; margin-bottom:10px;">
                        ...
                        <button class="btn btn-success" onclick="acceptOrderByCourier(\${o.id})">🏍️ Sifarişi Qəbul Et</button>
                    </div>
                \`).join('');
            }
            ...
            async function completeDelivery() {
                ...
                alert('Sifariş müştəriyə təslim edildi.');
